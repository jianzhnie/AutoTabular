...
bankm_train.to_pickle(PROCESSED_DATA_DIR / 'bankm_train.pkl')
bankm_val.to_pickle(PROCESSED_DATA_DIR / 'bankm_val.pkl')
bankm_test.to_pickle(PROCESSED_DATA_DIR / 'bankm_test.pkl')

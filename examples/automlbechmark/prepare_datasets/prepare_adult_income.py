...
adult_train.to_pickle(PROCESSED_DATA_DIR / 'adult_train.pkl')
adult_val.to_pickle(PROCESSED_DATA_DIR / 'adult_val.pkl')
adult_test.to_pickle(PROCESSED_DATA_DIR / 'adult_test.pkl')

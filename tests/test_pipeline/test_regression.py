...
import autotabular.pipeline.components.regression as regression_components
import numpy as np
...
class SimpleRegressionPipelineTest(unittest.TestCase):
    ...
    def test_multioutput(self):
        ...
        cs = SimpleRegressionPipeline(dataset_properties=dataset_properties).\
            get_hyperparameter_search_space()
        self._test_configurations(
            cs, data=data, dataset_properties=dataset_properties)
    ...
    def test_default_configuration_iterative_fit(self):
        ...
        for i in range(1, 11):
            ...
            self.assertEqual(
                regressor.steps[-1][-1].choice.estimator.n_estimators, i)
    ...
    def test_predict_batched_sparse(self):
        ...
        default = cs.get_default_configuration()
        regressor = SimpleRegressionPipeline(
            default, dataset_properties=dataset_properties, include=include)

...
import autotabular.pipeline.components.classification as classification_components
import autotabular.pipeline.components.feature_preprocessing as preprocessing_components
import numpy as np
...
class SimpleClassificationPipelineTest(unittest.TestCase):
    ...
    def test_configurations_categorical_data(self):
        ...
        init_params = {'data_preprocessing:feat_type': categorical}
    ...
    @unittest.mock.patch(
        'autotabular.pipeline.components.data_preprocessing'
    ...
    def test_categorical_passed_to_one_hot_encoder(self, ohe_mock):
        ...
        with unittest.mock.patch(
                'autotabular.pipeline.classification.SimpleClassificationPipeline'
            ...
            try:
                ...
                if 'Floating-point under-/overflow occurred at epoch' in \
                    ...
                    continue
                     ...
                     'values.' in e.args[0]:
                    continue
                elif 'Internal work array size computation failed' in e.args[
                        0]:
                    continue
                else:
                    print(config)
    ...
    def test_get_hyperparameter_search_space_include_exclude_models(self):
        ...
        fpp2 = CategoricalHyperparameter('feature_preprocessor:__choice__',
    ...
    def _test_set_hyperparameter_choice(self, expected_key, implementation,
                                        config_dict):
        """Given a configuration in config, this procedure makes sure that the
        given implementation, which should be a Choice component, honors the
        type of the object, and any hyperparameter associated to it."""
        ...
        expected_sub_key = expected_key.replace(':__choice__',
                                                ':') + implementation_type
        expected_attributes = {}
    ...
    def _test_set_hyperparameter_component(self, expected_key, implementation,
                                           config_dict):
        """Given a configuration in config, this procedure makes sure that the
        given implementation, which should be a autotabular component, honors
    ...
    def test_set_hyperparameters_honors_configuration(self):
        ...
        This method tests that the set hyperparameters actually create objects that comply with the given configuration. It iterates trough the pipeline to make
        sure we did not miss a step, but also checks at the end that every configuration from Config was checked
        """
    ...
    def test_fit_instantiates_component(self):
        """Make sure that if a preprocessor is added, it's fit method is
        called."""

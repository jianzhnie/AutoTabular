...
from autotabular.pipeline.components.data_preprocessing.category_encoders.backward_difference_encoder import BDEncoderTransformer
...
class BDEncoderTransformerTest(unittest.TestCase):
    ...
    def test_data_type_consistency(self):
        ...
        Y = BDEncoderTransformer().fit_transform(X)

...
from autotabular.pipeline.components.data_preprocessing.category_encoders.count_encoder import CountEncoderTransformer
...
class CountEncoderTransformerTest(unittest.TestCase):
    ...
    def test_data_type_consistency(self):
        ...
        Y = CountEncoderTransformer().fit_transform(X)
    ...
    def test_default_configuration(self):
        transformations = []
        for i in range(2):
            configuration_space = CountEncoderTransformer.get_hyperparameter_search_space(
            )
            default = configuration_space.get_default_configuration()

            preprocessor = CountEncoderTransformer(
                random_state=1,
                **{

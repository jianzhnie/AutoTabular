...
from autotabular.pipeline.components.data_preprocessing.category_encoders.hash_encoder import HashingEncoderTransformer
...
class HashingEncoderTransformerTest(unittest.TestCase):
    ...
    def test_data_type_consistency(self):
        ...
        Y = HashingEncoderTransformer().fit_transform(X)
    ...
    def test_default_configuration(self):
        transformations = []
        for i in range(2):
            configuration_space = HashingEncoderTransformer.get_hyperparameter_search_space(
            )
            default = configuration_space.get_default_configuration()

            preprocessor = HashingEncoderTransformer(
                random_state=1,
                **{

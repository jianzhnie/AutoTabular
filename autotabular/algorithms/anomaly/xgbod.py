...
from ..utils.utility import check_detector, check_parameter, precision_n_scores, standardizer
...
class XGBOD(BaseDetector):
    ...
    def decision_function(self, X):
        ...
        check_is_fitted(self,
                        ['clf_', 'decision_scores_', 'labels_', '_scalar'])
    ...
    def predict(self, X):
        """Predict if a particular sample is an outlier or not. Calling xgboost
        `predict` function.
    ...
    def predict_proba(self, X):
        """Predict the probability of a sample being outlier. Calling xgboost

...
class TabNetEncoder(torch.nn.Module):
    ...
    def __init__(
        ...
        """Defines main part of the TabNet network without the embedding
        layers.
...
class EmbeddingGenerator(torch.nn.Module):
    ...
    def forward(self, x):
        """Apply embeddings to inputs Inputs should be (batch_size, input_dim)
...
class RandomObfuscator(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        """
        obfuscated_vars = torch.bernoulli(self.pretraining_ratio *

...
import numpy as np
from autotabular.evaluation.abstract_evaluator import AbstractEvaluator, _fit_and_suppress_warnings
...
class TestEvaluator(AbstractEvaluator):
    ...
    def fit_predict_and_loss(self) -> None:
        _fit_and_suppress_warnings(self.logger, self.model, self.X_train,
                                   self.Y_train)

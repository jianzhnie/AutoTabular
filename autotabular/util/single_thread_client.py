...
class DummyFuture(dask.distributed.Future):
    """A class that mimics a distributed Future, the outcome of performing
    submit on a distributed client."""
...
class SingleThreadedClient(dask.distributed.Client):
    ...
    def __init__(self) -> None:
        ...
        implemented_methods = [
            'submit', 'close', 'shutdown', 'write_scheduler_file',
            '_get_scheduler_info', 'nthreads'
        ]
        method_list = [
            func for func in dir(dask.distributed.Client)

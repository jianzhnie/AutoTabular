...
class Balancing(AutotabularPreprocessingAlgorithm):
    ...
    def fit(self,
            ...
            y: Optional[PIPELINE_DATA_DTYPE] = None) -> 'Balancing':
        self.fitted_ = True
        return self
    ...
    def get_weights(
        ...
        clf_ = [
            'adaboost', 'random_forest', 'extra_trees', 'sgd',
        ...
        if classifier in clf_ or preprocessor in pre_:
            ...
            if preprocessor in pre_:
                fit_params[
                    'feature_preprocessor:sample_weight'] = sample_weights

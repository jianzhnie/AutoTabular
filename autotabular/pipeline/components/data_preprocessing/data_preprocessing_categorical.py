...
from autotabular.pipeline.components.data_preprocessing.category_shift.\
    category_shift import CategoryShift
from autotabular.pipeline.components.data_preprocessing.imputation.\
    categorical_imputation import CategoricalImputation
from autotabular.pipeline.components.data_preprocessing.minority_coalescense \
    import CoalescenseChoice
from autotabular.pipeline.components.data_preprocessing.categorical_encoding \
    import OHEChoice
from autotabular.pipeline.components.data_preprocessing.categorical_encoding.encoding import (
    OrdinalEncoding
)

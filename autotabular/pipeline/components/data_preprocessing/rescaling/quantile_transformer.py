...
from autotabular.pipeline.constants import DENSE, UNSIGNED_DATA, SIGNED_DATA, SPARSE, INPUT
from autotabular.pipeline.components.data_preprocessing.rescaling.abstract_rescaling \
    import Rescaling
from autotabular.pipeline.components.base import \
    AutotabularPreprocessingAlgorithm


class QuantileTransformerComponent(Rescaling, AutotabularPreprocessingAlgorithm):

...
from autotabular.pipeline.constants import DENSE, UNSIGNED_DATA, SIGNED_DATA, INPUT, SPARSE
...
class RobustScalerComponent(Rescaling, AutotabularPreprocessingAlgorithm):

...
class BDEncoderTransformer(AutotabularPreprocessingAlgorithm):
    ...
    def fit(self,
            ...
            y: Optional[PIPELINE_DATA_DTYPE] = None) -> 'BDEncoderTransformer':

        self.preprocessor = BDEncoder(cols=self.cols)
    ...
    def get_properties(
        ...
        return {
            'shortname': 'BDEncoderTransformer',
            'name': 'BackwardDifferenceEncoder Transformer',
...
class BDEncoder(object):
    ...
    def __init__(self, cols=None):
        self.enc = BackwardDifferenceEncoder(
            cols=cols,
            verbose=1,

...
class TargetEncoderTransformer(AutotabularPreprocessingAlgorithm):
    ...
    def fit(self,
        ...
        self.preprocessor = TEncoder(cols=self.cols)
    ...
    def get_properties(
        ...
        return {
            'shortname': 'TargetEncoderTransformer',
            'name': 'TargetEncoder Transformer',

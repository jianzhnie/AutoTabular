...
class GLMMEncoderTransformer(AutotabularPreprocessingAlgorithm):
    ...
    def fit(self,
            ...
            ) -> 'GLMMEncoderTransformer':

        self.preprocessor = GlmmEncoder(cols=self.cols)
    ...
    def get_properties(
        ...
        return {
            'shortname': 'GLMMEncoderTransformer',
            'name': 'GLMMEncoder Transformer',

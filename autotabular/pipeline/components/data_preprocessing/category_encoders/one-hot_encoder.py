...
class OneHotEncoderTransformer(AutotabularPreprocessingAlgorithm):
    ...
    def fit(self,
        ...
        self.preprocessor = OHEncoder(cols=self.cols)
    ...
    def get_properties(
        ...
        return {
            'shortname': 'OneHotEncoderTransformer',
            'name': 'OneHotEncoder Transformer',

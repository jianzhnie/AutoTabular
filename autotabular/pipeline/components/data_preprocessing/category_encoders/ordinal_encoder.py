...
class OrdinalEncoderTransformer(AutotabularPreprocessingAlgorithm):
    ...
    def fit(self,
        ...
        self.preprocessor = OdEncoder(cols=self.cols)
    ...
    def get_properties(
        ...
        return {
            'shortname': 'OrdinalEncoderTransformer',
            'name': 'OrdinalEncoder Transformer',

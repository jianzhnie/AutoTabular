...
* [Documentation](https://automl.github.io/Auto-tabular/master/manual.html)
    * If it's related but not clear, please include it in your question with a link, we'll try to make it better!
* [Examples](https://automl.github.io/Auto-tabular/master/examples/index.html)
...
* [Issues](https://github.com/automl/Auto-tabular/issues?q=label%3Aquestion+)
...
* Which version of `Auto-tabular` are you using?
